...
*   [Linsxyx/KugouMusic.NET](https://github.com/Linsxyx/KugouMusic.NET) - 最好用最轻量的第三方酷狗概念版音乐播放器
...
*   [mapleafgo/singcast](https://github.com/mapleafgo/singcast) - Multi-platform proxy client powered by sing-box, with Clash config support
...
*   [huasenjio/huasenjio-compose](https://github.com/huasenjio/huasenjio-compose) - 花森起始页是一款开源的 AI 导航与内容聚合平台，集网址导航、博客、AI 助手、插件授权与后台管理于一体，帮助个人和团队快速搭建智能化上网入口。
